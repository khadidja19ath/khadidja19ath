...
<!-- Animated Header -->
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=A78BFA&center=true&vCenter=true&width=600&lines=Hi%2C+I'm+AIT+HOCINE+KHADIDJA+%F0%9F%91%8B;AI+Engineering+Student;Building+Intelligent+Systems" alt="Typing SVG" />
...
<p>
  ...
  <a href="mailto:aithocinekhadidja19gmail.com">
...
```python
ahla = {
    "role"       : "AI Engineering Student (2024–2028)",
...
![Gantt](https://img.shields.io/badge/Gantt_Charts-0078D4?style=for-the-badge&logo=microsoftproject&logoColor=white)
...
|--------|-------------|-------|--------|
| 🫀 **[Heart Disease Dashboard](https://github.com/YOUR_USERNAME/heart-disease-dashboard)** | Interactive dashboard predicting heart disease risk with visual analytics | Python · Streamlit · Scikit-learn | ✅ Live |
| 📡 **[Telco Churn Predictor](https://github.com/YOUR_USERNAME/telco-churn)** | End-to-end ML pipeline predicting customer churn for telecom companies | Python · Pandas · ML Models | 🔨 Building |
| 👁️ **[OCT Retinal AI](https://github.com/YOUR_USERNAME/oct-retinal-analysis)** | Deep learning model for retinal disease detection from OCT scans (Kermany dataset) | TensorFlow · CNN · Kaggle | 🔬 Research |
| 🏥 **[Hospital Database](https://github.com/YOUR_USERNAME/hospital-db)** | Relational hospital management system with complex SQL queries | MySQL · SQL | ✅ Complete |
...
<img height="160" src="https://github-readme-stats.vercel.app/api?username=YOUR_USERNAME&show_icons=true&theme=tokyonight&hide_border=true&count_private=true&rank_icon=github"/>
&nbsp;&nbsp;
...
> *"I build AI systems that make a difference — from retinal screening tools to predictive analytics for real businesses."*
